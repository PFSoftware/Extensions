...
namespace PFSoftware.Extensions
{
    /// <summary>This class implements INotifyPropertyChanged and allows inherited classes to use NotifyPropertyChanged in an easier fashion.</summary>
